...
zip = "60441"
     ...
     ggplot(graphdf, aes( x = Year, y = Price)) + geom_point() + labs(title = "Vehicle Price Vs. Vehicle Year") + scale_y_continuous("Price", limits = c(0,400000)) + scale_x_continuous("Model Year")
